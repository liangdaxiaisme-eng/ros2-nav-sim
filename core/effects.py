...
class BootSequence:
    ...
    def __init__(self, width: int, height: int):
        ...
        self.boot_messages = [
            ...
            "[SYS] Loading map data... OK",
            "[MAP] 200x200 grid (5cm/cell) — 6698 walls",
            "[MAP] 10 rooms, 15 doors detected",
            "[PLN] A* planner initialized",
            "[PLN] DWA local planner ready",
            "[SEN] LaserScan: 180 rays, 8.0m range",
            "[SEN] IMU: 100Hz, quaternion mode",
            "[SEN] Odometry: differential drive",
            "[NAV] Costmap inflation: 5 cells",
            "[NAV] 9 waypoint presets loaded",
            "[SYS] Particle system: 500 max",
            "[BOT] DifferentialDriveRobot v2.1",
            "[BOT] Max: 1.5m/s linear, 3.0rad/s angular",
            "[SYS] ══════════════════════════════════",
            "[SYS] ✅ ALL SYSTEMS NOMINAL",
            "[SYS] Ready for navigation.",
            "",
        ]
